...
public class SControllerAdviceLow {

	private static final Logger logger = LoggerFactory.getLogger(SControllerAdviceLow.class);
	...
	public String handleAnyException(
		...
		logger.debug(String.format("[ LOW] [%s] %s", requestType, message));
